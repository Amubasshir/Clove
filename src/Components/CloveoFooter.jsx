...
const CloveoFooter = () => {
  return (
    <div className="w-full font-outfit bg-gray-50  pt-32">
      <style jsx global>{`
      ...
      <div className="relative z-20 px-4 md:px-8 max-w-7xl mx-auto -mb-32 md:-mb-28">
        {/* Removed overflow-hidden so images can pop out if needed */}
        <div className="bg-gradient-to-r from-[#3ca5ff] to-[#258aff] rounded-[40px] shadow-2xl flex flex-col md:flex-row items-center relative min-h-[400px] md:min-h-[420px]">
          ...
          <div className="hidden md:block w-full md:w-[50%] h-full absolute bottom-0 right-0 pointer-events-none">
             ...
             {/* Back Image (Brown Shirt) */}
             <img 
               src="https://i.ibb.co/Myyqr2sX/71f51ca71fcb3a905f7abf59764e05bc1665226b.png" 
               alt="Woman in brown" 
               className="absolute bottom-0 right-4 w-[230px] object-contain z-20"
             />

             {/* Front Image (Denim Shirt) */}
             <img 
      ...
      {/* --- FOOTER SECTION --- */}
      <footer className="bg-[#0f111a] text-white pt-56 pb-10 px-4 md:px-8 relative z-10 overflow-hidden font-outfit">
        
        {/* Background Texture */}
        <div className="absolute top-0 left-0 w-full h-full opacity-40 pointer-events-none" 
             style={{ backgroundImage: 'radial-gradient(circle at 50% 0%, #1a2236 0%, transparent 70%)' }}>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20 relative z-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-4 text-gray-400 text-[15px] font-light">
              ...
              <li><a href="#" className="hover:text-white transition-colors">How Its Works</a></li>
